...
import "./shaders/simulation_material";
import "./shaders/dof_points_material";
...
export function Particles({
  ...
  useFrame((state) => {
    ...
    // console.log("t", state.clock.elapsedTime, /*uFocus, uFov, uBlur,*/ target.texture);

    //  transfer data from simulation material to the actual render material
